#!/usr/bin/env python
"""Fix corrupted Python files by rewriting them with proper syntax."""

import os

# Script to fix the corrupted weather_load.py

weather_load_code = r'''from __future__ import annotations
...
file_path = r'd:\weather_api\scripts\weather_load.py'
os.makedirs(os.path.dirname(file_path), exist_ok=True)

with open(file_path, 'w', encoding='utf-8') as f:
    f.write(weather_load_code)
